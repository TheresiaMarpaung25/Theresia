...
-- insert data --
INSERT INTO penulis(nama, kota) VALUES('Samter', 'Bandung');
INSERT INTO penulis(nama, kota) VALUES('Theresia', 'Medan');

INSERT INTO penerbit(nama, kota) VALUES('Putri', 'Jogja');
INSERT INTO penerbit(nama, kota) VALUES('Tinambunan', 'Yogyakarta');

INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('11S18065', 'Sunny Everywhere', 2, 2, 100000, 50);
INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('11S18066', 'Lumpu', 2, 1, 150000, 10);
INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('111xx1112', 'Pulang Pergi', 1, 1, 350000, 120);
